...
<form method="POST" action="{{ route('data_pegawai.update', ['id' => $pegawai->id]) }}">
	...
	<div>
		...
		<select name="id_jenjang_pendidikan" id="id_jenjang_pendidikan">
			<option value="1"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '1') }}>S3</option>
			<option value="2"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '2') }}>Sp-1</option>
			<option value="3"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '3') }}>Sp-2</option>
			<option value="4"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '4') }}>S2</option>
			<option value="5"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '5') }}>Sp-1(K)</option>
			<option value="6"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '6') }}>PROFESI</option>
			<option value="7"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '7') }}>S1</option>
			<option value="8"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '8') }}>SMU/SLTA</option>
			<option value="9"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '9') }}>D3</option>
			<option value="10"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '10') }}>SMP/SLTP</option>
			<option value="11"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '11') }}>SD</option>
			<option value="12"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '12') }}>D1</option>
			<option value="13"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '13') }}>D4</option>
			<option value="14"  {{ isSelectedValue($pegawai->id_jenjang_pendidikan, '14') }}>D2</option>
		</select>
	</div>
	<div>
